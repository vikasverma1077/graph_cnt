...
def arg_parse():
    ...
    parser.add_argument('--bs', dest='bs', type=int, default=20, help = 'batch size')
    ...
    parser.add_argument('--usup-sup-method', dest='usup_sup_method', type= str,  default='last_layer',
                         help = 'can be last_layer, random_layer, all_layer')
    ...
    parser.add_argument('--weight-decay', dest='weight_decay', type=float, default=0,
            help='')
    parser.add_argument('--logfilename',  type=str, default='log.txt',
                        help='')
